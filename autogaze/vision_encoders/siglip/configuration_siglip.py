...
class SiglipVisionConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        scales='224',
        max_embed_batch_size=None,  # can set to a small number (e.g. 64) to save memory
        ...
        **kwargs,
        ...
        self.frame_independent_encoding = frame_independent_encoding
        self.scales = scales
        self.max_embed_batch_size = max_embed_batch_size
